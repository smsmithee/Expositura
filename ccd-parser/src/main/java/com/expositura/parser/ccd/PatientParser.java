    ...
    for (int i = 0; i < nodeList.getLength(); i++) {
      ...
      if (child.hasAttributes() || child.hasChildNodes()) {
        switch (child.getNamespaceURI() + "|" + child.getLocalName()) {
          ...
          case "urn:hl7-org:sdtc|sdtcDesc" -> patient.setSdtcDesc(EdParser.fromXml(child));
          ...
          case "urn:hl7-org:sdtc|sdtcDeceasedInd" -> patient.setSdtcDeceasedInd(BlParser.fromXml(child));
          case "urn:hl7-org:sdtc|sdtcDeceasedTime" -> patient.setSdtcDeceasedTime(TsParser.fromXml(child));
          case "urn:hl7-org:sdtc|sdtcMultipleBirthInd" -> patient.setSdtcMultipleBirthInd(BlParser.fromXml(child));
          case "urn:hl7-org:sdtc|sdtcMultipleBirthOrderNumber" -> patient.setSdtcMultipleBirthOrderNumber(IntPosParser.fromXml(child));
          ...
          case "urn:hl7-org:v3|raceCode" -> patient.setRaceCode(CeParser.fromXml(child));
          case "urn:hl7-org:sdtc|sdtcRaceCode" -> patient.addSdtcRaceCode(CeParser.fromXml(child));
          case "urn:hl7-org:v3|ethnicGroupCode" -> patient.setRaceCode(CeParser.fromXml(child));
          case "urn:hl7-org:sdtc|sdtcEthnicGroupCode" -> patient.addSdtcEthnicGroupCode(CeParser.fromXml(child));
